...
import { nigerianStates, practiceAreas, checkIfEmailExists } from '@/lib/data';
...
export default function RegisterLawyerPage() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      scn: '', tagline: '', bio: '', city: '', yearsOfExperience: 0,
      practiceAreas: [], terms: false, referralCode: ''
    },
  });
    ...
    <div className="flex justify-center items-center py-12">
      <Card className="w-full max-w-xl shadow-xl">
        <CardHeader className="items-center text-center">
          ...
          <CardDescription>
             {user ? "You are already signed in. Fill out the form below to apply." : "Join our network of trusted legal experts."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
