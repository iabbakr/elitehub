    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (fetchedProduct) {
          ...
          const [fetchedVendor] = await Promise.all([
            fetchVendorById(fetchedProduct.vendorId),
            // fetchRelatedProducts(fetchedProduct.category, productId) // This can be implemented in data.ts
          ]);
          setVendor(fetchedVendor);

           // --- Track View ---
          const viewedKey = `viewed-product-${productId}`;
