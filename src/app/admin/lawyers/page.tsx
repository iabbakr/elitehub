...
export default function AllLawyersPage() {
  ...
  useEffect(() => {
    ...
    const handleKycDecision = async (decision: 'verified' | 'rejected') => {
        ...
        const agentRef = doc(db, 'lawyers', kycReviewModal.agent.id);
